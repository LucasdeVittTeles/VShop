...
public class IdentityConfiguration
{
      ...
      new List<Client>
      {
               //cliente genérico
                ...
                new Client
                {
                    ...
                    RedirectUris = {"https://localhost:7248/signin-oidc"},//login
                    PostLogoutRedirectUris = {"https://localhost:7248/signout-callback-oidc"},//logout
    ...
    {
        new ApiResource("vshop", "VShop API")
        {
            Scopes = { "vshop" }
        }
    };
